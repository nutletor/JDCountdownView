...
@interface FindPwdViewController ()<JDCountdownViewDelegate>
...
- (void)tapCountdownViewAction:(JDCountdownView *)countdownView
{
    ...
    if (/**/(1)) {  //验证码发送成功
        SetNewPwdViewController * setNewPwdVC = [[SetNewPwdViewController alloc] initWithNibName:@"SetNewPwdViewController" bundle:nil];
